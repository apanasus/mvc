...
<div class="container">
    ...
    <div class="card-grid">
        ...
        <div class="card"><div class="card-header">
            <img src="/img/vebzaim.png" alt="WebZaim">
            <span class="rating">5.0</span>
            <div class="stars">
                ★★★★★
            </div>
        ...
        <div class="card"><div class="card-header">
            <img src="/img/zaimer.png" alt="Zaymer">
            <span class="rating">5.0</span>
            <div class="stars">
                ★★★★★
            </div>
        ...
        <div class="card">
            <div class="card-header">
            <img src="/img/vebbankir.png" alt="Webbankir">
            <span class="rating">5.0</span>
            <div class="stars">
                ★★★★★
            </div>
...
<!--        <a href="/tracker?utm_source=--><?php //echo $data['source']; ?><!--&offer_id=--><?php //echo $offer->id; ?><!--" target="_blank">-->
<!--            <div class="card">-->
    ...
    <div class="footer-content">
        ...
        <div class="footer-text">
            <p>Общество с ограниченной ответственностью «БСМЕДИА» ОГРН 1216300005536</p>
                ...
                <p>Если хотите разместить предложение на нашей витрине, вам нужны клиенты или вы хотите работать с нами — заполните форму <a href="#">Сотрудничество</a>.</p>
                ...
                <p>Данное соглашение действует бессрочно и может быть отозвано путем отправки заявления в форме <a href="#">Отказа от рекламных предложений и услуг подбора</a> указав номер телефона, на который оставлена заявка.</p>
